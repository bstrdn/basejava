...
- Реализуйте класс `com.twodonik.webapp.storage.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
6. `com.twodonik.webapp.model.Resume r` — давай переменным осмысленные имена, например `resume`. `r` допустимо в коротких циклах и лямбдах.
...
1. Не меняйте сигнатуры методов в `com.twodonik.webapp.storage.ArrayStorage`
